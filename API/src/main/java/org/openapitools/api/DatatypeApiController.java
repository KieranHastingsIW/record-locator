...
public class DatatypeApiController implements DatatypeApi {
    ...
    public ResponseEntity<DTModel> dataTypeGetById(@Valid @RequestParam(value = "dataTypeId", required = true) Long datatypeId){
        return dataTypeService.getDataTypeById(dataTypeId);
    }
